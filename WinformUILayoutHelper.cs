...
namespace DeltaWoodSystem.SanTuo.UI.Tools
{
    ...
    public class WinformUILayoutHelper
    {
        ...
        public struct structControlBorderInfo
        {
            private int ctrlBorderWidth;    //所需要绘制的控件边框宽度
            public int CtrlBorderWidth
            {
                get { return ctrlBorderWidth; }
                set { ctrlBorderWidth = value; }
            }
            int ctrlBorderMargin;           //所需要绘制的边框与控件间的间距
            public int CtrlBorderMargin
            {
                get { return ctrlBorderMargin; }
                set { ctrlBorderMargin = value; }
            }
            int disBetweenTextImage;        //控件中的图片与控件间的距离
            public int DisBetweenTextImage
            {
                get { return disBetweenTextImage; }
                set { disBetweenTextImage = value; }
            }
            private bool isActive;          //控件是否处于激活状态
            public bool IsActive
            {
                get { return isActive; }
                set { isActive = value; }
            }
            private bool isBorderColorLinerChange;//控件的边框颜色是否线性变化
            public bool IsBorderColorLinerChange
            {
                get { return this.isBorderColorLinerChange; }
                set { this.isBorderColorLinerChange = value; }
            }
            private Image leftTextImage;    //控件中的图片
            public Image LeftTextImage
            {
                get { return leftTextImage; }
                set { leftTextImage = value; }
            }
            private Color normalColor;      //控件正常状态显示时的边框颜色
            public Color NormalColor
            {
                get { return normalColor; }
                set { normalColor = value; }
            }
            private Color activeBorder;     //边框处于激活状态时的边框颜色
            public Color ActiveBorder
            {
                get { return activeBorder; }
                set { activeBorder = value; }
            }
            private Rectangle recTextBorder;//所绘制的控件周围的边框大小，不用设置，会自行计算，若有需要直接获取即可
            public Rectangle RecTextBorder
            {
                get { return recTextBorder; }
                set { recTextBorder = value; }
            }
            private Control targetControl;  //所要绘制的控件
